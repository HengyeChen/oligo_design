function [all_mat,final_seq] = OligoLib(oligo_file,bkg_file,isBScheck,PWM_folder,cutoffFile,oligo_region,PF,PR,cutsite,result_file,output_seqs)
dbstop if error
...
for a = 1:length(oligo_seq)% a is the index of oligo
    ...
    oligo = [PF oligo(oligo_region(1):oligo_region(2)) PR];
